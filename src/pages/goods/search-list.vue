...
export default {
  ...
  methods: {
    navigateTo: function () {
      let url =
        '/pages/goods/search?keyword=' +
        this.keyword.search +
        '&coupon_id=' +
        this.keyword.coupon_id +
        '&from=/pages/goods/search-list';
      uni.redirectTo({
        url: url
      });
    },
    ...
    toDetail: function (item) {
      uni.navigateTo({ url: '/pages/goods/detail?id=' + item.id + '&task_browse=' + this.task_browse });
    }
  },
  onLoad(options) {
