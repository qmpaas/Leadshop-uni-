<template>
  <view class="list-sort flex justify-around align-center" :data-theme="theme">
    ...
    <view
      ...
      @tap="setActive('t.task_number')"
      :class="key === 't.task_number' ? 'he-item-1' : 'he-item-0'"
    >
      <view class="he-text">价格</view>
      <view class="flex flex-direction">
        <text
          class="iconfont he-price iconproductlist_rank_first"
          :class="key === 't.task_number' && sort === 'ASC' ? 'he-icon' : 'he-default-icon'"
        ></text>
        <text
          class="iconfont he-price iconproductlist_rank_second"
          :class="key === 't.task_number' && sort === 'DESC' ? 'he-icon' : 'he-default-icon'"
        ></text>
      </view>
    </view>
    <view class="he-item he-text" @tap="setActive('t.id')" :class="key === 't.id' ? 'he-item-1' : 'he-item-0'"
      >最新</view
    >
  </view>
</template>
